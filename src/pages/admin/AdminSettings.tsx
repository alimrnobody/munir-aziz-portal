  ...
  return (
    <DashboardLayout>
      <div className="mx-auto max-w-7xl p-4 sm:p-6 lg:p-8">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:bg-[#0F172A] dark:border-white/10 dark:shadow-[0_10px_30px_rgba(0,0,0,0.4)] sm:p-8">
          ...
          <button
            ...
            className="mt-6 w-full rounded-lg bg-slate-900 px-4 py-2 text-sm font-medium text-white sm:w-auto"
          >
            Manage Courses
          </button>
        </div>

        <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:bg-[#0F172A] dark:border-white/10 dark:shadow-[0_10px_30px_rgba(0,0,0,0.4)] sm:p-8">
          <div className="flex items-start justify-between gap-4">
            <div>
